package br.com.ifood.adminservice.framework.utils;

import br.com.ifood.adminservice.framework.constants.PatternConstants.NetworkConstants;
...
public class NetworkUtils {
    ...
    public static Function<NetworkDTO, NetworkDTO> getLocalHostAddress = (network) -> {
    ...
    public static Function<HttpServletRequest, NetworkDTO> getDeviceAddresses = (request) -> {
